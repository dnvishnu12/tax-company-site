...
export default function Info() {
    return (
      <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-[10rem] lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
              <h2 className="text-2xl font-bold tracking-tight text-gray-900 text-center">OUR VISION</h2>
          ...
          <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
            <div className="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
              <h2 className="text-2xl font-bold tracking-tight text-gray-900 text-center">OUR MISSION</h2>
              <p className="mt-4 text-left">
