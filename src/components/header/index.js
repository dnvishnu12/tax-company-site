      ...
      <div className="relative isolate px-6 pt-5 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Empowering individuals and businesses with expert tax and financial solutions for over 15 years. Navigate the complexities of finance with confidence and clarity.
            </p>
